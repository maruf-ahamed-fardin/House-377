...
// String literal replacements for Prisma enums
const ExpenseCategoryEnum = z.enum(["ELECTRICITY", "GAS", "INTERNET", "CLEANING", "MAINTENANCE", "WATER", "OTHER"]);
const NoticePriorityEnum = z.enum(["NORMAL", "IMPORTANT", "URGENT"]);
const RentDistributionModeEnum = z.enum(["EQUAL", "PROFILE"]);
...
export const rentSummaryFormSchema = z.object({
  ...
  rentDistributionMode: RentDistributionModeEnum,
  notes: optionalTextSchema,
});
