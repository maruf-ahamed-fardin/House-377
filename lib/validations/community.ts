...
import { optionalTextSchema, requiredDateSchema } from "@/lib/validations/shared";
...
export const bazarScheduleRequestDecisionSchema = z.object({
  ...
  status: z.nativeEnum(RequestStatus).refine((value) => value !== "PENDING", "Select approve or reject."),
